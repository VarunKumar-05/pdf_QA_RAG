...
from fastapi.middleware.cors import CORSMiddlewareQDRANT_COLLECTION = "all_pdf_chunks"
...
async def generate_questions(request: QuestionGenerationRequest):
    try:
        ...
        if  len(top_sentences)==0 or all(passage['score']< similarity_threshold for passage in top_sentences):
